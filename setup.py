...
.. moduleauthor:: corp-0 <andresfranco.rs@gmail.com>
"""
...
setup(
    name='armadocs',
    description="Python tools to auto-generate documentation for Arma3 projects",
    ...
    url= 'https://github.com/corp-0/armadocs',
    download_url=(
        f'https://github.com/corp-0/'
        f'armadocs/archive/{version}.tar.gz'
    ),
    keywords=[
